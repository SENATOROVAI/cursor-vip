...
```bash
bash <(curl -Lk https://github.com/kingparks/cursor-vip/releases/download/latest/i.sh) 0eabc82dcec9679f418a9cb7587a76c8
```
Method 2: Install via ghp.ci proxy script
```bash
bash <(curl -Lk https://ghp.ci/https://github.com/kingparks/cursor-vip/releases/download/latest/install.sh) 0eabc82dcec9679f418a9cb7587a76c8
```
...
cursor-vip 0eabc82dcec9679f418a9cb7587a76c8;
# Windows 
...
1. After cloning this repository, replace `0eabc82dcec9679f418a9cb7587a76c8` in the `README` with your DeviceID.
